"""
hdfc.py  —  HDFC Bank Server  (port 5002, India)
================================================
Responsibilities:
  • Signup / Login  (bcrypt PIN)
  • Card generation: XXXX5002XXXX
...
BANK_NAME = "HDFC"
BANK_PORT = PORTS["HDFC"]

COUNTRY_URLS = server_urls(PORTS.get("india") or PORTS.get("India"))
...
def country_post(path, payload=None, timeout=60):
    last_err = None
...
def run_recovery():
    # HDFC
    try:
        subprocess.run(["python", "hdfc_recovery.py"], check=True, timeout=30)
