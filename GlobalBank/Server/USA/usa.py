"""
usa.py  —  USA Country Server  (port 6000)
===========================================
Responsibilities:
  • Monitor health of JPMC (6001) and BOA (6002)
...
def run_recovery():
    try:
        subprocess.run(["python", "usa_recovery.py"], check=True, timeout=30)
...
def start():
    log("USA country server starting")
    run_recovery()
